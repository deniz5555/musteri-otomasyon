...
export async function renderSettings(container) {
    ...
    container.innerHTML = `
        ...
        <div class="settings-section card fade-in-up" style="animation-delay:0ms">
            ...
            <p style="color:var(--accent-orange);font-size:var(--font-xs);margin:-4px 0 var(--space-md) 0;padding:10px 12px;background:var(--accent-orange-dim, rgba(255,140,0,0.12));border-radius:var(--radius-md);border:1px solid var(--border-color)"><strong>Resend test kuralı:</strong> Gönderen <code style="font-size:11px">onboarding@resend.dev</code> iken yalnızca Resend’e kayıtlı <em>kendi</em> e-postanıza gönderebilirsiniz. Lead / müşteri adreslerine göndermek için <a href="https://resend.com/domains" target="_blank" rel="noopener noreferrer">Alan adı doğrulama</a> yapıp From’u kendi domaininizden seçin.</p>
